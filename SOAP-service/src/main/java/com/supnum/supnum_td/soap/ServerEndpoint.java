...
public class ServerEndpoint {
    ...
    // util: Entity -> SOAP Server
    private com.supnum.supnum_td.soap.Server toSoapServer(Server entity) {
        com.supnum.supnum_td.soap.Server s = new com.supnum.supnum_td.soap.Server();
        s.setId(entity.getId());
        s.setName(entity.getName());
        s.setIpAddress(entity.getIpAddress());
        s.setRunning(entity.isRunning());
        return s;
    }
    ...
    public CreateServerResponse createServer(@RequestPayload CreateServerRequest request) {
        ...
        response.setServer(toSoapServer(saved));  
        return response;
    }
    ...
    public ListServersResponse listServers(@RequestPayload ListServersRequest request) {
        ...
        List<com.supnum.supnum_td.soap.Server> soapServers = servers.stream()
                .map(this::toSoapServer)
                .collect(Collectors.toList());

        ListServersResponse response = new ListServersResponse();
        response.setServers(soapServers);
        return response;
    }
    ...
    public StartServerResponse startServer(@RequestPayload StartServerRequest request) {
        ...
        response.setServer(toSoapServer(server));
        return response;
    }
